...
# Testing on vbkick boxes

## This worked on CentOS with --cpe specified, results show pass, fail, etc.
profile="usgcb-rhel6-server"
resultsdir="."
oscap xccdf eval --profile $profile --results $resultsdir/$profile-results.xml \
--cpe /usr/share/xml/scap/ssg/content/ssg-rhel6-cpe-dictionary.xml \
/usr/share/xml/scap/ssg/content/ssg-rhel6-xccdf.xml

## This worked on CentOS with --cpe specified, results show pass, fail, etc. with a report
profile="usgcb-rhel6-server"
resultsdir="."
oscap xccdf eval --profile $profile \
--results $resultsdir/$profile-results.xml \
--report $resultsdir/$profile-results.html \
--cpe /usr/share/xml/scap/ssg/content/ssg-rhel6-cpe-dictionary.xml \
/usr/share/xml/scap/ssg/content/ssg-rhel6-xccdf.xml
